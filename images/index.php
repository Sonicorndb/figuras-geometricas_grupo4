...
imagestring($image, 5, 180, 100, "Libre Configuracion", $text_color);
imagestring($image, 3, 160, 120, "Desarrollo de Aplicaciones Web", $text_color);

// Datos de un círculo con radio 50
...
// Datos de un cuadrado relleno de color azul
$rect_x1 = 500;   // Coordenada X de la esquina superior izquierda del cuadrado
$rect_y1 = 500;   // Coordenada Y de la esquina superior izquierda del cuadrado
$rect_x2 = 300;  // Coordenada X de la esquina inferior derecha del cuadrado
$rect_y2 = 300;  // Coordenada Y de la esquina inferior derecha del cuadrado

// Dibujar el cuadrado relleno
imagefilledrectangle($image, $rect_x1, $rect_y1, $rect_x2, $rect_y2, $filled_square_color);

// Datos de un círculo (círculo pequeño)
$cx2 = 300; // Coordenada X del centro del segundo círculo
$cy2 = 200; // Coordenada Y del centro del segundo círculo
$r2 = 40;   // Radio del segundo círculo

// Dibujar el segundo círculo
imageellipse($image, $cx2, $cy2, $r2 * 2, $r2 * 2, $circle_color);

// Datos de un punto amarillo (un solo píxel)
